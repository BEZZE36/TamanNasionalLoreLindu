...
class Fauna extends Model
{
    ...
    public function getImageUrlAttribute(): string
    {
        ...
        if ($this->image_data) {
            return route('images.fauna', $this->id);
        }
    ...
    {
        return $query->whereIn('conservation_status', [self::STATUS_VU, self::STATUS_EN, self::STATUS_CR]);
    }

    public function images()
    {
        return $this->hasMany(FaunaImage::class)->orderBy('sort_order');
    }

    public function comments()
    {
        return $this->hasMany(FaunaComment::class)->orderBy('created_at', 'desc');
    }
