<script setup>
/**
 * NewsCard.vue - Premium News Card with GSAP animations
 * Features: Glassmorphism, hover effects, author info, views, likes
 * Theme: Rose/Red for News
 */
import { computed } from 'vue';
import { Link } from '@inertiajs/vue3';
import { Calendar, Clock, Eye, Heart, ArrowRight, User, Megaphone } from 'lucide-vue-next';
...
<template>
    <Link :href="`/news/${article.slug}`" 
          class="news-card group block bg-white rounded-2xl overflow-hidden border border-gray-100 hover:border-rose-200 shadow-lg hover:shadow-2xl hover:shadow-rose-500/10 transition-all duration-500 hover:-translate-y-2" 
        ...
        <div class="relative h-44 sm:h-48 overflow-hidden">
            ...
            <div class="absolute top-3 left-3">
                <span class="px-2.5 py-1 rounded-full text-[10px] font-bold bg-gradient-to-r from-rose-500 to-red-600 text-white shadow-lg shadow-rose-500/30 flex items-center gap-1">
        ...
        <div class="p-4 sm:p-5">
            <!-- Title -->
            <h3 class="text-sm sm:text-base font-bold text-gray-900 mb-2 line-clamp-2 group-hover:text-rose-600 transition-colors leading-tight">
                {{ article.title }}
            </h3>
            ...
            <div class="flex items-center justify-between pt-3 border-t border-gray-100">
                <!-- Author & Date -->
                <div class="flex items-center gap-2">
                    <div class="w-6 h-6 rounded-full bg-gradient-to-br from-rose-100 to-red-100 flex items-center justify-center">
                        <User class="w-3 h-3 text-rose-600" />
                    </div>
                ...
                <!-- Read More -->
                <span class="flex items-center gap-1 text-[10px] font-semibold text-rose-600 group-hover:text-rose-700">
