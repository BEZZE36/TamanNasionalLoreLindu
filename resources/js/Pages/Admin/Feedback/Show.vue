...
const submitReply = () => { replyForm.post(`/admin/feedback/${props.feedback.id}/reply`, { onSuccess: () => replyForm.reset() }); };
...
const updateReply = (r) => { editForm.put(`/admin/feedback-replies/${r.id}`, { onSuccess: () => cancelEditReply() }); };
const deleteReply = (r) => { if (confirm('Hapus balasan ini?')) router.delete(`/admin/feedback-replies/${r.id}`); };
    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-amber-500 via-orange-500 to-red-500 p-5 shadow-xl">
            ...
            <div class="relative flex items-center gap-3">
                ...
                <Link :href="`/admin/feedback/${feedback.id}/edit`" class="inline-flex items-center gap-2 px-5 py-2.5 bg-white/20 text-white rounded-xl font-bold hover:bg-white/30 transition-all">
