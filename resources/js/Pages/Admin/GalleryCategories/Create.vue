...
const submit = () => { form.post('/admin/gallery-categories'); };
</script>
    ...
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-violet-500 via-purple-500 to-fuchsia-500 p-5 shadow-xl">
            ...
            <div class="relative flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-3xl font-extrabold text-white tracking-tight drop-shadow-lg">Tambah Kategori</h1>
                    <p class="mt-1 text-violet-100/90">Buat kategori galeri baru</p>
                </div>
            </div>
        </div>
        ...
        <form @submit.prevent="submit" class="space-y-4">
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                ...
                <div class="p-8 space-y-6">
                    <div>
                        ...
                        <input v-model="form.name" type="text" required placeholder="Landscape, Wildlife, dll"
                    ...
                    <div>
                        ...
                        <textarea v-model="form.description" rows="3" placeholder="Deskripsi kategori..."
            ...
            <div class="flex justify-end">
                <button type="submit" :disabled="form.processing"
                    ...
                    <Save class="w-6 h-6" /><span>{{ form.processing ? 'Menyimpan...' : 'Simpan Kategori' }}</span>
                </button>
            </div>
        </form>
    </div>
