...
const quickPublish = () => { form.is_published = true; submit(); };
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <div class="flex items-center gap-2">
                            <h1 class="text-base font-bold text-white tracking-tight">Tulis Berita Baru</h1>
                            <Sparkles class="w-3.5 h-3.5 text-amber-300" />
                        </div>
                        <p class="text-red-100/80 text-[10px]">Buat berita terbaru</p>
                    </div>
                </div>
                <div class="flex items-center gap-2">
                    ...
                    <button type="button" @click="quickPublish" :disabled="!isFormValid || form.processing"
                        ...
                        :class="isFormValid ? 'bg-white text-red-600 hover:bg-red-50 shadow-lg' : 'bg-white/20 text-white/60'">
                        <Send class="w-3 h-3" /><span>Publish</span>
                    </button>
                </div>
            </div>
        </div>
            ...
            <div class="lg:col-span-2 space-y-4">
                <div class="form-section bg-white rounded-xl shadow-md border border-gray-100 p-4 hover:shadow-lg transition-shadow">
                    <h3 class="text-xs font-bold text-gray-900 mb-3 flex items-center gap-2">
                        <Type class="w-4 h-4 text-red-500" />Judul & Ringkasan
                    </h3>
                    <div class="space-y-3">
                        <div class="relative">
                ...
                <div class="form-section bg-white rounded-xl shadow-md border border-gray-100 p-4 hover:shadow-lg transition-shadow">
                    ...
                    <TinyMceEditor v-model="form.content" id="news-content" :height="350" placeholder="Tulis konten berita..." />
                </div>
