...
import { ShieldOff, Mail, LogOut, RefreshCw, Lock, HelpCircle, Copy, Check, X } from 'lucide-vue-next';
...
const emailSubject = 'Permintaan Aktivasi Akun Admin';
const emailBody = 'Halo Super Admin,\n\nSaya ingin meminta agar akun admin saya diaktifkan kembali.\n\nNama: \nEmail: \nAlasan: \n\nTerima kasih.';
...
// WhatsApp URL
const whatsappUrl = `https://wa.me/${contactPhone}?text=${encodeURIComponent('Halo Super Admin, saya ingin meminta diaktifkan kembali akun admin saya.')}`;
...
// Check if admin is still blocked
const checkStatus = async () => {
    ...
    try {
        ...
        if (response.ok) {
            ...
            if (data.is_active) {
                // Admin has been reactivated, redirect to dashboard
...
<template>
    <Head title="Akun Admin Dinonaktifkan" />
        ...
        <div class="relative z-10 w-full max-w-sm">
            ...
            <div class="relative bg-white/[0.06] backdrop-blur-xl rounded-2xl border border-white/10 overflow-hidden">
                ...
                <div class="px-5 pt-6 pb-4 text-center">
                    ...
                    <!-- Title -->
                    <h1 class="fade-item text-lg sm:text-xl font-black text-white mb-1">Akun Dinonaktifkan</h1>
                    <p class="fade-item text-gray-400 text-xs sm:text-sm leading-relaxed">
                        Akun admin Anda telah dinonaktifkan oleh administrator.
                    </p>
                </div>
                    ...
                    <div class="fade-item p-3 rounded-lg bg-amber-500/5 border border-amber-500/10">
                        <div class="flex gap-2">
                            ...
                            <p class="text-[10px] sm:text-[11px] text-gray-400 leading-relaxed">
                                Hubungi Super Admin untuk mengaktifkan kembali akun Anda.
                            </p>
                        </div>
                    </div>
