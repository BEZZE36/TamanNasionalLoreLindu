...
import { FileText, Save, CheckCircle, Loader2, Eye, Scale } from 'lucide-vue-next';
...
<template>
    <div class="min-h-screen space-y-5">
        <!-- Premium Header -->
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-purple-600 via-violet-600 to-indigo-600 p-6 shadow-2xl">
            ...
            <div class="relative flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-white tracking-tight drop-shadow-lg">Syarat & Ketentuan</h1>
                        <p class="text-violet-100/80 text-xs">Edit konten halaman syarat dan ketentuan website</p>
                    </div>
                </div>
        ...
        <form @submit.prevent="submit" class="space-y-5">
            ...
            <div class="section-card rounded-xl bg-white shadow-lg border border-gray-100 overflow-hidden">
                <div class="bg-gradient-to-r from-purple-50 via-violet-50 to-purple-50 px-5 py-4 border-b border-gray-100">
                    <div class="flex items-center gap-3">
                        <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-purple-500 to-violet-600 shadow-lg shadow-purple-500/30">
                ...
                <div class="p-5">
                    <TinyMceEditor v-model="form.content" id="terms-editor" :height="400" placeholder="Tulis syarat dan ketentuan di sini..." />
                </div>
            </div>
            ...
            <div class="sticky bottom-4 flex justify-end z-20">
                <button type="submit" :disabled="form.processing"
                    class="group inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-purple-600 via-violet-600 to-indigo-600 px-6 py-3 text-white text-xs font-bold shadow-2xl shadow-purple-500/40 hover:shadow-purple-500/60 hover:-translate-y-0.5 hover:scale-105 transition-all duration-300 disabled:opacity-50">
