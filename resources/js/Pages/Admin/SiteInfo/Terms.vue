...
const submit = () => {
    form.put('/admin/site-info/terms', {
...
<template>
    <div class="max-w-4xl mx-auto space-y-6">
        <!-- Premium Header -->
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-purple-500 via-violet-500 to-purple-600 p-5 shadow-xl">
            ...
            <div class="relative flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-3xl font-extrabold text-white tracking-tight drop-shadow-lg">Syarat & Ketentuan</h1>
                    <p class="mt-1 text-violet-100/90 text-lg">Edit konten halaman syarat dan ketentuan</p>
                </div>
            </div>
        </div>
        ...
        <div v-if="showSuccess" class="flex items-center gap-4 rounded-2xl bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200/60 px-6 py-5 shadow-lg">
            ...
            <div><p class="font-bold text-emerald-800">Berhasil!</p><p class="text-emerald-600 text-sm">Syarat & Ketentuan berhasil diperbarui!</p></div>
        </div>

        <form @submit.prevent="submit">
            <div class="rounded-3xl bg-white shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
                <div class="relative px-8 py-6 bg-gradient-to-r from-purple-50 via-violet-50 to-purple-50 border-b border-gray-100">
                    <div class="flex items-center gap-3">
                        <div class="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-purple-400 to-violet-500 shadow-lg shadow-purple-500/30">
                ...
                <div class="p-8">
                    <TinyMceEditor v-model="form.content" id="terms-editor" :height="500" placeholder="Tulis syarat dan ketentuan di sini..." />
                </div>
            </div>

            <div class="flex justify-end mt-8">
                <button type="submit" :disabled="form.processing"
                    class="group relative inline-flex items-center gap-3 rounded-2xl bg-gradient-to-r from-purple-500 to-violet-500 px-10 py-5 text-white font-bold text-lg shadow-2xl shadow-purple-500/30 hover:shadow-purple-500/50 hover:-translate-y-1 transition-all duration-500 disabled:opacity-50">
